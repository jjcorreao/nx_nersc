...
RUN wget http://download.nomachine.com/download/4.6/Linux/nomachine-cloud-server-evaluation_4.6.4_14_x86_64.tar.gz -P /usr \
	&& tar -zxvf /usr/nomachine-cloud-server-evaluation_4.6.4_14_x86_64.tar.gz -C /usr \
	&& /usr/NX/nxserver --install
